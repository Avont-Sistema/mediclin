...
const COLOR_MAP_PREVIEW: Record<
  ColorKey,
  { text: string; gradient: string; badge: string; soft: string }
> = {
  teal: {
    text: "text-teal-600",
                  ...
                  <div className="absolute inset-0 overflow-y-auto bg-slate-50 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                      ...
                      <div className="pt-6 pb-16 px-3">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white px-4 py-5 mb-3 text-center">
                          ...
                          <p className="text-xs font-semibold text-slate-900">
                            {previewName || "Seu nome"}
                          </p>
                          <p className={`text-[11px] ${colors.text} mt-0.5`}>
                            {previewSpecialty || "Especialidade"}
                          </p>
                          {headline && (
                              ...
                              return (
                                ...
                                >
                                  <div className="flex items-start gap-1.5">
                                    <div
                                      className={`grid size-7 place-items-center rounded-lg ${colors.soft} ${colors.text} shrink-0`}
                                    >
                        ...
                        <div className="mb-3">
                          <div className="flex items-center gap-2 mb-2">
                            <div
                              className={`size-5 rounded-full ${colors.badge} flex items-center justify-center shrink-0`}
                            >
                              ...
                              {svcs
                                ...
                                .map((svc) => (
                                  ...
                                  >
                                    ...
                                    {svc.descricao && (
                                      <p className={`text-[9px] mt-0.5 truncate ${colors.text}`}>
                                        {svc.descricao}
                                      </p>
                                    )}
                                    <div className="mt-1.5 border-t border-slate-100 pt-1 flex items-center justify-between">
                                      ...
                                      <span className="text-[10px] font-black text-slate-900">
                                        {Number(svc.preco).toLocaleString("pt-BR", {
                                          style: "currency",
                                          currency: "BRL",
                                        })}
                                      </span>
                                    ...
                                    <p
                                      className={`mt-1 text-[8px] font-bold ${colors.text} opacity-0 group-hover:opacity-100 transition-opacity text-center`}
                                    >
                                      Toque para agendar →
                                    </p>
                                  </button>
                    ...
                    {previewPhase === "data" && previewSvc && (
                      <div className="pt-6 pb-6 px-3">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <p className="text-[10px] font-semibold text-slate-800 truncate flex-1">
                            {previewSvc.nome}
                          </p>
                        </div>
                        {/* Step */}
                        ...
                        <div className="rounded-xl bg-white border border-slate-100 p-2.5 mb-4 flex items-center gap-2">
                          <div
                            className={`size-7 rounded-lg ${colors.soft} flex items-center justify-center shrink-0`}
                          >
                          ...
                          <p className="text-[10px] font-black text-slate-900 shrink-0">
                            {Number(previewSvc.preco).toLocaleString("pt-BR", {
                              style: "currency",
                              currency: "BRL",
                            })}
                          </p>
                        ...
                        <p className="text-center text-[9px] text-slate-400">
                          Toque em uma data para continuar
                        </p>
                      </div>
                    )}
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[9px] text-slate-500">
                              {previewDate.day}, {previewDate.dateStr}
                            </p>
                          </div>
                        </div>
                        {/* Step */}
                    ...
                    {previewPhase === "confirmado" && previewSvc && previewDate && previewSlot && (
                      <div className="pt-8 pb-6 px-3 flex flex-col items-center">
                        ...
                        <p className="text-sm font-black text-slate-900 mb-0.5 text-center">
                        ...
                        <div className="w-full rounded-xl border border-slate-200 bg-white p-3 mb-3 space-y-1.5">
                          ...
                          <div className="space-y-1 pt-1 border-t border-slate-100">
                            ...
                            <div className="flex items-center gap-1.5 text-[9px] text-slate-600">
                              <span>⏰</span>
                              {previewSlot} · {previewSvc.duracaoMinutos} min
                            </div>
                            <div className="flex items-center gap-1.5 text-[9px] text-slate-600">
                              <span>💰</span>
                              {Number(previewSvc.preco).toLocaleString("pt-BR", {
                        ...
                        <p
                          className="mt-3 text-center text-[9px] font-semibold leading-snug"
...
function ServiceRow({
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded-xl border px-4 py-3 transition-all ${svc.ativo ? "border-slate-100 bg-slate-50" : "border-slate-100 bg-white opacity-60"}`}
    >
      ...
      >
        <span
          className={`inline-block h-3.5 w-3.5 rounded-full bg-white shadow transition-transform ${svc.ativo ? "translate-x-4" : "translate-x-1"}`}
        />
      </button>
