...
import { DemoFinanceiroContent } from "../components/DemoFinanceiroContent";
...
export const Route = createFileRoute("/demo-financeiro")({
  head: () => ({
    meta: [
      { title: "Financeiro — CuidandoVC Demo" },
      { name: "description", content: "Demonstração do módulo financeiro no CuidandoVC." },
    ],
  }),
  component: DemoFinanceiroPage,
});
...
function DemoFinanceiroPage() {
  return (
    <div>
      <DemoBanner />
      <DemoFinanceiroContent />
    </div>
  );
}
