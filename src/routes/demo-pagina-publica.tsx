...
import { DemoPaginaPublicaContent } from "../components/DemoPaginaPublicaContent";
import { Rocket, X } from "lucide-react";
import { useState } from "react";

export const Route = createFileRoute("/demo-pagina-publica")({
  head: () => ({
    meta: [
      { title: "Página Pública — CuidandoVC Demo" },
      { name: "description", content: "Demonstração da página pública de agendamento no CuidandoVC." },
    ],
  }),
  component: DemoPaginaPublicaPage,
});
...
function DemoPaginaPublicaPage() {
  return (
    <div>
      <DemoBanner />
      <DemoPaginaPublicaContent />
    </div>
  );
}
