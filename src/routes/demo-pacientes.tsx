...
import { DemoPacientesContent } from "../components/DemoPacientesContent";
import { Rocket, X } from "lucide-react";
import { useState } from "react";

export const Route = createFileRoute("/demo-pacientes")({
  head: () => ({
    meta: [
      { title: "Pacientes — CuidandoVC Demo" },
      { name: "description", content: "Demonstração do gerenciamento de pacientes no CuidandoVC." },
    ],
  }),
  component: DemoPacientesPage,
});
...
function DemoPacientesPage() {
  return (
    <div>
      <DemoBanner />
      <DemoPacientesContent />
    </div>
  );
}
